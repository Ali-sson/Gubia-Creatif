...
export default function Booking() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      <h2 className="text-3xl font-bold mb-4">Book a Cleaning Service</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-5 rounded-lg shadow">
        ...
        <button type="submit" className="w-full bg-yellow-500 text-black font-bold py-2 rounded hover:bg-yellow-400 transition">
